...
2. Use the CDN hosted version.
    ...
    stylesheet:
    ```
    https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.1.0/dist/cc.css
    ```

    script:
    ```
    https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.1.0/dist/cc.umd.js
    ```
...
<html>
    <head>
        <!-- head content -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.1.0/dist/cc.css">
    </head>
    <body>
        <!-- body content -->
...
```javascript{1}
import 'https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.1.0/dist/cc.umd.js';
...
import "vanilla-cookieconsent/dist/cc.css";
...
Declare the `cc.css` style in the `angular.json` file:
```json{6}
{
    ...
        "build": {
            "options": {
                "styles": [
                    "node_modules/vanilla-cookieconsent/dist/cc.css"
                ]
            }
        }
    ...
